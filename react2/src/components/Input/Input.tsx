...
export function Input({value, type, name, onChange, placeholder, label, error}: Props) {

  return (
    <div className="py-1 ">
          {label && <label htmlFor={name} className="text-base leading-normal mb-1 block">{label}</label>}
      <input
        type={type}
        value={value}
